...
class JaLanguage implements BaseLanguage {
  ...
  List<Map<String, String>> get termsCards => [
    ...
    {
      'title': '4. 知的財産権および著作権',
      'content': 'UI/UXデザイン、イラスト、3Dマスコット、AppliQロゴ、アーキテクチャ、およびソースコードは、Muhamad Sidik / Arch Studio (@Imyusi_) の独占的知的財産です。事前の書面による許可なく、本アプリを複製、再配布、リバースエンジニアリング、または権利主張することを固く禁じます。',
    },
    {
      'title': '5. 免責事項・非保証',
