        ...
        border: Border.all(
          color: isExpanded
              ? (isMonochrome
                  ...
                  : (isDark ? AppColors.pastelLime.withValues(alpha: 0.6) : AppColors.pastelLime))
              : borderColor,
                    ...
                    decoration: BoxDecoration(
                      color: isExpanded
                          ? (isMonochrome
                              ...
                              : AppColors.pastelLime.withValues(alpha: 0.2))
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: isMonochrome
                ...
                : AppColors.pastelLime.withValues(alpha: 0.5),
